...
export const api = {
  ...
  listBooks: () => request({ url: '/api/books' }),
  createBook: (name) => request({ url: '/api/books', method: 'POST', data: { name } }),
  switchBook: (bookId) => request({ url: '/api/books/switch', method: 'POST', data: { bookId } }),
